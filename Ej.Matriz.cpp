// Ej.Matriz.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
int main()
{
	...
	float prom;
	Matrix m1;//Se crea objeto m1 de la clase Matrix
	do {
	...
	//m1.set_fil(fil); si uso esto dejo los parentesis vacios en el .h y directamente uso los atributos
	//m1.set_col(col);
	//Menu
	do {
		cout << "\t Menu\n";
